...
class AccountPayment(models.Model):
    ...
    droit_timbre_supplier = fields.Monetary(string="Droit de timbre")
    supplier_move_id = fields.Many2one('account.move', string="Pièce comptable de timbre fournisseur", readonly="1")
    ...
    def create(self, vals):
        ...
        log.warning('CREATE-------------------{}'.format(res.supplier_move_id.state))
        if res.state == 'posted':
