...
class AccountPayment(models.Model):
    ...
    def _prepare_move_line_default_vals(self, write_off_line_vals=None):
        ...
        for payment in self:
            ...
            if payment.use_timbre and line_vals_list and payment.partner_type != "supplier":
    ...
    **************************************************************************************
    ...
    def _calcule_timbre(self):
        for payment in self:
            if payment.use_timbre and payment.partner_type != "supplier":
