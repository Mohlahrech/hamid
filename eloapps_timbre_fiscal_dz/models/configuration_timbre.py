...
class ResCompany(models.Model):
    ...
    def _timbre(self, montant):
        ...
        if self.tranche:
            montant_du_timbre = round((montant * self.prix) / self.tranche)

            if montant_du_timbre > self.mnt_max:
                montant_du_timbre = self.mnt_max
            if montant_du_timbre < self.mnt_min:
                montant_du_timbre = self.mnt_min

        return montant_du_timbre
